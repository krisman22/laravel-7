...
<body>
	...
	<div class="container">
		<center>
			<h4>Import Excel Data Barang Ke Database</h4>
		</center>
		...
		<div class="modal fade" id="importExcel" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
			<div class="modal-dialog" role="document">
				<form method="post" action="/barang/import_barang" enctype="multipart/form-data">
		...
		<table class='table table-bordered'>
			...
			@php $i=1 @endphp
				...
				<tr>
					<td>{{ $i++ }}</td>
					<td>{{$b->kode_kelompok_barang}}</td>
					<td>{{$b->uraian_kelompok_barang}}</td>
